...
import { Plus, BarChart3, List, Printer } from 'lucide-react';
...
export default function Home() {
  const { projects, loading, addProject, updateProject, deleteProject, updateProjectHistory } = useProjects();
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-teal-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-green-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                <Printer size={20} />
                Print to PDF
              </button>
